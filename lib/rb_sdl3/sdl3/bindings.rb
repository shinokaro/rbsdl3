    ...
    module Bindings
      def included(m)
        m.module_eval {
          ...
          const_set :SDL_MICRO_VERSION, 24
          ...
          extern "float SDL_randf()"
          extern "Uint32 SDL_rand_bits()"
          ...
          extern "SDL_AssertData * SDL_GetAssertionReport()"
          ...
          extern "SDL_ThreadID SDL_GetCurrentThreadID()"
          ...
          extern "SDL_RWLock * SDL_CreateRWLock()"
          ...
          extern "SDL_Condition * SDL_CreateCondition()"
          ...
          extern "char * SDL_GetCurrentAudioDriver()"
          ...
          extern "char * SDL_GetCurrentCameraDriver()"
          ...
          extern "char * SDL_GetCurrentVideoDriver()"
